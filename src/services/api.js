  ...
  getData: async (resourceType, id = null) => {
    ...
    switch(resourceType) {
      case 'clients':
        ...
        break;
      case 'designers':
        data = id ? designers.designers.find(d => d.id === id) : designers.designers;
        break;
      case 'vendors':
      ...
      case 'admins':
        ...
        break;
      case 'projects':
        data = id ? projects.projects.find(p => p.id === id) : projects.projects;
        break;
      case 'products':
        data = id ? products.products.find(p => p.id === id) : products.products;
        break;
