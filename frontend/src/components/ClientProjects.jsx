...
function ClientProjects({ username, role, userId }) {
  ...
  useEffect(() => {
    console.log("🔄 ClientProjects projects data updated:", projects);
  }, [projects]);
  ...
  const getDesigner = (designerId) => {
    return designers.find((d) => d.id === designerId) || { name: "Unassigned Designer" };
  };
  ...
  return (
    <div className="container-fluid py-4">
      ...
      <p className="text-muted">
      ...
      </p>      <div className="row g-4">
        {projects.map((project) => {
          // Use actual project progress or default based on status
          ...
          console.log(`📊 Project ${project.id} progress:`, progress, "Status:", project.status);
        ...
        <ProjectDetails
          ...
          client={getDesigner(selectedProject.designer_id)}
